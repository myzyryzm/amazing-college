...
<div class="page-banner">
    ...
    <div class="page-banner__content container t-center c-white">
        <h1 class="headline headline--large">Fuck Off!</h1>
...
?>
    ...
    <div class="full-width-split__two">
        <div class="full-width-split__inner">
            ...
            <?php
// WP_QUERY defaults to 10 posts per query
$homepagePosts = new WP_Query(array(
    'posts_per_page' => 2,
));
while ($homepagePosts->have_posts()) {
    // gets all appropiate data for posts
...
if (has_excerpt()) {
    ...
    ?>
            ...
            <?php }
// resets the normal wp queries; not always necessary but good to do
wp_reset_postdata();
?>
